    ...
    public MilestoneCalculator() {
        ...
        calculateButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                if (q1 <= 25 && q2 <= 40 && q3 <= 35 && q1 != 0 && q2 != 0 && q3 != 0) {
                Output output = new Output(stud);
                output.setVisible(true);
                }   
                else {
                JOptionPane.showMessageDialog(null, "Please enter valid scores:\nMaximum grade for Milestone 1 should be 25 points,\nMilestone 2 should be 40 points,\nTerminal Assessment should be 35 points.");
                        }   
            }
        });
    }
